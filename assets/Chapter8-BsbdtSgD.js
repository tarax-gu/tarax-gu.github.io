import{_ as r,r as e,o as d,m as h,b as i,w as o,p,i as _,a as n,e as l}from"./index-DBKJjhjt.js";const f={},j=t=>(p("data-v-a580f85f"),t=t(),_(),t),O={class:"container"},m=j(()=>n("div",{class:"content"},[n("h1",{id:"section8"},"第八章 排序"),n("h2",{id:"section8.1"},"8.1 排序的基本概念"),n("h3",{id:"section8.1.1"},"8.1.1 排序的定义"),n("p",null," 排序，即重新排列表中元素，使表中元素满足按关键字有序的过程。 若两个元素关键字相同，排序后不交换元素先后顺序，则称该排序算法为稳定的。 "),n("h2",{id:"section8.2"},"8.2 插入排序"),n("h3",{id:"section8.2.1"},"8.2.1 直接插入排序"),n("ul",null,[l(" 即先找出元素位置，然后将之后的元素后移一位，将该元素复制到该位置。 "),n("li",null,"空间复杂度：O(1)"),n("li",null,"时间复杂度：O(n2)"),n("li",null,"稳定的，可用于链表。")]),n("pre",null,[l("                "),n("code",null,`
